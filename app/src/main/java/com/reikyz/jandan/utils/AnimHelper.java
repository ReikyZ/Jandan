...
/*    public static void showGuideImgAnim(final ImageView view) {
    ...
    public static void showItemLoading(Context context, View view) {
        AnimatorSet set = new AnimatorSet();
        float curretnY = view.getTranslationY();
        set.playTogether(ObjectAnimator.ofFloat(view, "translationY", curretnY + 50f, curretnY),
                ObjectAnimator.ofFloat(view, "alpha", 0f, 1f));
        set.setDuration(200);
        set.setInterpolator(AnimationUtils.loadInterpolator(context,
    ...
    public static void showFiltersLayoutAnim(HListView view) {
        view.setLayoutAnimation(getListAlphaController());
    }
    ...
    public static void showLoadingAnim(Context context, ListView lv) {
