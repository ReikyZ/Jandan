...
public class ShadowLayout extends FrameLayout {
    ...
    private void setBackgroundCompat(int w, int h) {
        if (bitmap == null)
            bitmap = createShadowBitmap(w, h, mCornerRadius, mShadowRadius, mDx, mDy, mShadowColor, Color.TRANSPARENT);
...
//        bitmap.recycle();
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mOnlyTop = attr.getBoolean(R.styleable.ShadowLayout_sl_only_top, false);
