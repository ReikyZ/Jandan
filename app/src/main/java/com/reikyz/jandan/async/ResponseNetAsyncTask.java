...
import com.reikyz.api.utils.HttpCode;
...
public abstract class ResponseNetAsyncTask extends AsyncTask<Void, Void, ApiResponse> {
    ...
    protected ResponseNetAsyncTask(Context ctx, boolean openDialog, LMListView listView) {
        this.ctx = ctx;
        this.openDialog = openDialog;
    ...
    protected ResponseNetAsyncTask(Context ctx, boolean openDialog, LMListView listView, boolean showErrorMsg) {
        this.ctx = ctx;
        this.openDialog = openDialog;
        this.listView = listView;
        this.showErrorMsg = showErrorMsg;
